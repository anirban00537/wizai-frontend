              ...
              <div className="py-5">
                <div className="grid grid-cols-1 justify-items-center gap-5 sm:grid-cols-2 sm:justify-items-stretch md:grid-cols-3 md:gap-4 lg:gap-6 2xl:grid-cols-4">
                  {templateLists?.data?.list.map((item: any, index: any) => (
                    <div className="relative flex h-full w-full transform flex-col items-center gap-6 rounded-xl border p-4 transition duration-300 ease-in-out hover:scale-105 hover:bg-white hover:shadow-lg md:p-10">
                      <BsStarFill
                        onClick={() => {
